<%-- 
    Document   : CEdepartments
    Created on : 21-jun-2016, 22:15:09
    Author     : ivan
--%>
...
<html>
    <head>
        <meta charset="utf-8">
            ...
            <title>Crear Editar Departamentos</title>
    ...
    <body>
        ...
        <form action="DepartmentController" method="POST">
            <% String action = request.getParameter("action");
             ...
             %>
             <input type="text" name="id" value="<c:out value="${department.id}"/>"  style="visibility:hidden"/><br>
             <div class="md-form">
                <i class="fa fa-map-o prefix"></i>
                <input type="text" id="form2" class="form-control" name="name" value="<c:out value="${department.name}"/>" />  
                <label for="form2">Nombre Departamento</label>
            </div>
                <div class="col-md-5">
                </div>
                <div class ="col-md-2">
