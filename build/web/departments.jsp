<%-- 
    ...
    Created on : 21-jun-2016, 22:11:34
    Author     : ivan
--%>
...
<html>
    ...
    <body>
        ...
        <div class="col-md-12">
            <a href="DepartmentController?action=insert" type="button" class="btn btn-primary">Crear Departamento&nbsp;&nbsp;<i class="fa fa-plus-circle"></i></a>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="DepartmentController?action=edit&id=<c:out value="${department.id}"/>">Editar</a></td>
                <td><a href="DepartmentController?action=delete&id=<c:out value="${department.id}"/>">Eliminar</a></td>
