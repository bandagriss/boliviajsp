<%-- 
    Document   : provinces
    Created on : 22-jun-2016, 11:47:41
    Author     : ivan
--%>
...
<html>
    <head>
        <meta charset="utf-8">
            ...
            <title>Provincias de Bolivia</title>
    ...
    <body>
        ...
        <div class="col-md-12">
            <a href="Provincia?action=insert" type="button" class="btn btn-primary">Crear Provincia&nbsp;&nbsp;<i class="fa fa-plus-circle"></i></a>
            ...
            <tbody>
              <c:forEach items="${provinces}" var="province">
                    ...
                    <td><c:out value="${province.department_id}" /></td>
